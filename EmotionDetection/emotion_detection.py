...
# Specifically done for Task # 3 & Beyond for Final Project
def emotion_detector_Task3(text_to_analyse): 
...
# Specifically done for Task # 7 & Beyond for Final Project
